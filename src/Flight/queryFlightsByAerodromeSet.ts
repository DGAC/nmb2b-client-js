...
import type { FlightListByAerodromeSetReply, FlightListByAerodromeSetRequest } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().FlightManagementService.FlightManagementPort.queryFlightsByAerodromeSet.input,
});
