...
import type { FlightListByAirspaceReply, FlightListByAirspaceRequest } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().FlightManagementService.FlightManagementPort.queryFlightsByAirspace.input,
});
