...
export type BasicTrajectoryData = {
  takeOffWeight?: mixed,
  topOfClimb?: Array<mixed>,
  topOfDescent?: Array<mixed>,
  bottomOfClimb?: Array<mixed>,
  bottomOfDescent?: Array<mixed>,
  distanceAtLocationInfo: mixed,
};
...
export type OtherAerodromeDesignation =
  | {
      aerodromeName?: mixed,
      aerodromeLocation?: mixed,
    }
  | { firstLastRoutePoint: mixed };
...
export type FlightPlan = {
  ...
  wakeTubulenceCategory?: mixed,
  flightType?: mixed,
  flightRules?: mixed,
  estimatedOffBlockTime: DateTimeMinute,
  icaoRoute: string,
  stayInformation?: Array<mixed>,
  enrouteDelays?: Array<mixed>,
  equipmentCapabilityAndStatus?: EquipmentCapabilityAndStatus,
  surveillanceEquipment?: mixed,
  otherInformation?: mixed,
  supplementaryInformation?: mixed,
};
