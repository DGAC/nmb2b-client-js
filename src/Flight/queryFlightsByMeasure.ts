...
import type { FlightListByMeasureRequest, FlightListByMeasureReply } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().FlightManagementService.FlightManagementPort.queryFlightsByMeasure.input,
});
