...
import type { FlightListByAerodromeReply, FlightListByAerodromeRequest } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().FlightManagementService.FlightManagementPort.queryFlightsByAerodrome.input,
});
