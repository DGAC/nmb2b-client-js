...
import type { CompleteAIXMDatasetReply, CompleteAIXMDatasetRequest } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().AirspaceStructureService.AirspaceStructurePort.queryCompleteAIXMDatasets
      .input,
});
