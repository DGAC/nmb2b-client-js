...
import type { TrafficType } from '../Flight/types';
...
export type SectorConfigurationPlan = {|
...
export type TrafficCountsByAirspaceRequest = {|
  ...TrafficCountsRequest,
  airspace: AirspaceId,
  calculationType: CountsCalculationType,
|};

export type TrafficCountsByTrafficVolumeRequest = {|
  ...TrafficCountsRequest,
  trafficVolume: TrafficVolumeId,
  calculationType: CountsCalculationType,
...
export type RegulationListRequest = {|
  ...RegulationOrMCDMOnlyListRequest,
...
export type RegulationOrMCDMOnlyListRequest = {|
  ...MeasureListRequest,
