...
import type { CapacityPlanRetrievalRequest, CapacityPlanRetrievalReply } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().TacticalUpdatesService.TacticalUpdatesPort.retrieveCapacityPlan.input,
});
