...
import type { TrafficCountsByAirspaceRequest, TrafficCountsByAirspaceReply } from './types.ts';
...
>({
  ...
  getSchema: (client) =>
    ...
    client.describe().TrafficCountsService.TrafficCountsPort.queryTrafficCountsByAirspace.input,
});
